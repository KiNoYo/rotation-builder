		...
		["defaultRotation/shaman/enhancement"] = {
			...
			["ActionList"] = {
				...
				["defaultRotation/shaman/stormstrike"] = {
					["v_togglename"] = "Toggle 1",
					["v_durationstartedtime"] = 0,
					["v_spellbookspellname"] = "73899",
					["v_keybind"] = "<keybind>",
				},
				["defaultRotation/shaman/lava_lash"] = {
					["v_togglename"] = "Toggle 1",
					["v_durationstartedtime"] = 0,
					["v_spellbookspellname"] = "60103",
					["v_keybind"] = "<keybind>",
				},
				["defaultRotation/shaman/elemental_blast"] = {
					["v_togglename"] = "Toggle 1",
					["v_durationstartedtime"] = 0,
					["v_spellbookspellname"] = "117014",
					["b_p_havebuff"] = true,
					["v_keybind"] = "<keybind>",
