if GetLocale() == "frFR" then
	ROB_FRAME_ROTATIONS_TT     = "Montrer Rotations"
	ROB_FRAME_OPTIONS_TT       = "Montrer Options"
	ROB_FRAME_CLOSE_TT         = "Fermer la Fenêtre de Rotation Builder"

	ROB_UI_TITLE               = "Rotation Builder"
	ROB_ADDON_NAME             = "RotationBuilder"
	ROB_UI_VERSION_LABEL       = "Version :"
	ROB_UI_RCOLUMNHEADER       = "Rotations"
	ROB_UI_RCOLUMNHEADER1      = "Listes"
	ROB_UI_CREATE              = "Créer"
	ROB_UI_CREATE_TT           = "Créer une nouvelle rotation"
	ROB_UI_MODIFY              = "Modifier"
	ROB_UI_MODIFY_TT           = "Modifier rotation sélectionnée"
	ROB_UI_SAVE                = "Sauvegarder"
	ROB_UI_SAVE_TT             = "Sauvegarder rotation sélectionnée"
	ROB_UI_DISCARD             = "Annuler"
	ROB_UI_DISCARD_TT          = "Annuler les modifications de la rotation sélectionnée"
	ROB_UI_DELETE              = "Supprimer"
	ROB_UI_DELETE_TT           = "Supprimer rotation sélectionnée"
	ROB_UI_TOGGLE              = "Activer Rotation Builder"
	ROB_UI_ROTATION_E1         = "Aucune rotation n'est spécifié pour ce raccourcie"
	ROB_UI_ROTATION_E2         = "La Rotation n'a pas été trouvé"
	ROB_UI_INTERRUPTED_MSG     = "Interrompu :"
	ROB_UI_LDB_TT1             = "<Clic Droit> pour ouvrir Rotation Builder"
	ROB_UI_LDB_TT2             = "<Clic Gauche> pour sélectionner une Rotation"

	ROB_UI_ACTION_COLUMN       = "Actions"
	ROB_UI_RN_LABEL            = "Nom de la Rotation:"
	ROB_UI_RS_LABEL            = "Porté du sort :"
	ROB_UI_RS_LABEL_TT         = "Entrer le nom du sort à utiliser pour vérifier si vous êtes à porté de votre cible et montrer sinon l'icône « Hors de porté ».\n(Cela n'a pas d'effet sur la rotation, cela affiche simplement l'icône en question)"
	ROB_UI_RKB_LABEL           = "Raccourci"
	ROB_UI_RKB_LABEL_TT        = "Précise quel raccourci sélectionne cette rotation"

	ROB_UI_A_ADD               = "Ajouter"
	ROB_UI_A_ADD_TT            = "Ajouter une nouvelle action dans la rotation"
	ROB_UI_A_COPY              = "Copier"
	ROB_UI_A_COPY_TT           = "Copier l'action sélectionnée dans le presse-papier"
	ROB_UI_A_PASTE             = "Coller"
	ROB_UI_A_PASTE_TT          = "Coller l'action copiée du presse-papier vers la rotation"

	ROB_UI_IMPORT              = "Importer"
	ROB_UI_IMPORT_TT           = "Importer une rotation"
	ROB_UI_IMPORT_MESSAGE      = "Pressez CTRL+V pour coller ici la chaîne de caractères représentant une rotation copier à partir d'une autre source :"
	ROB_UI_IMPORT_ERROR1       = "Échec de l'importation : aucun nom trouvé pour la rotation."
	ROB_UI_IMPORT_ERROR2       = "Échec de l'importation : une rotation existe déjà avec le même nom."
	ROB_UI_IMPORT_ERROR3       = "Échec de l'importation : la chaîne de caractères collée ne correspond pas au format d'export de « Rotation Builder »."
	ROB_UI_IMPORT_SUCCESS      = "Importation réussie"
	ROB_UI_EXPORT              = "Exporter"
	ROB_UI_EXPORT_TT           = "Exporter la rotation"
	ROB_UI_EXPORT_MESSAGE      = "Pressez CTRL+C pour copier la rotation dans le presse-papier afin de la coller (CTRL+V) plus tard."
	ROB_UI_ADD_ACTION_CFAIL    = "Les noms d'action ne peuvent utiliser les caractères suivant : [],="
	ROB_UI_ADD_ROTATION_CFAIL  = "Les noms de rotation ne peuvent utiliser les caractères suivant : [],"
	ROB_UI_OK_BUTTON           = "Ok"
	ROB_UI_CANCEL_BUTTON       = "Annuler"
	ROB_UI_CLOSE_BUTTON        = "Fermer"
	ROB_UI_ROTATION_TAB        = "Rotations"
	ROB_UI_SPELLLISTS_TAB      = "Lites de sorts"
	ROB_UI_OPTIONS_TAB         = "Options"
	ROB_UI_PRESSKEY            = "Appuyez sur une touche"
	ROB_UI_KEYBIND             = "<keybind>"

	ROB_UI_S_ADD_TT            = "Ajoutez un nouveau sort à cette liste"
	ROB_UI_S_REMOVE_TT         = "Retirez ce sort de la liste"
	ROB_UI_LN_LABEL            = "Nom de la liste :"
	ROB_UI_S_COLUMN            = "Sorts"

	ROB_UI_AO_GENERAL_TAB      = "General"
	ROB_UI_AO_GENERAL_LABEL    = "Options General :"
	ROB_UI_AO_G_SPELLNAME_L    = "Nom de sort \nou emplacement d'inventaire :"
	ROB_UI_AO_G_SPELLNAME_TT   = "Entrez le nom d'un sort ou d'un emplacement d'inventaire\nExemple1: |cFF00FF00Trinket0Slot|r pour le premier emplacement de bijou\nExemple2: |cFF00FF00Trinket1Slot|r pour le second emplacement de bijou\nExemple3: |cFF00FF00HandsSlot|r\nExemple4: |cFF00FF00Growl|r\nExemple5: |cFF00FF00\50\54\52\57|r id pour Growl"
	...
	ROB_UI_AO_C_DR             = "A portée de duel"
	ROB_UI_AO_C_DR_TT          = "Afficher l'action seulement si l'unité personnalisée est à moins de 10m métres"

   ROB_ACTION_MOVEUP_TT       = "Déplacer l'action sélectionnée d'une position vers le haut"
   ROB_ACTION_MOVEDOWN_TT     = "Déplacer l'action sélectionnée d'une position vers le bas"
   ROB_ACTION_REMOVE_TT       = "Retirer l'action de la liste"

   ROB_LOADED                 = "Rotation Builder v%s chargé"

   -- Dialog Prompt
   ROB_PROMPT_LIST_DELETE     = "Êtes vous sûr de vouloir la supprimer ?"
   ROB_PROMPT_SPELLLIST_DELETE = "Êtes vous sûr de vouloir la supprimer ?"
   -- Options
   ROB_OPTION_MINIMAPO        = "Options de la Minimap :"
   ROB_OPTION_MINIMAP         = "Bouton de la Minimap :"
   ROB_OPTION_MINIMAP_TT      = "Activer le bouton de la Minimap"
   ROB_OPTION_MINIMAPPOS      = "Position autour de la Minimap"
   ROB_OPTION_MMPOS_CV        = "300"
   ROB_OPTION_MMPOS_MIN       = "1"
   ROB_OPTION_MMPOS_MAX       = "360"
   ROB_OPTION_MINIMAPRAD      = "Rayon hors de la Minimap"
   ROB_OPTION_MMRAD_CV        = "80"   
   ROB_OPTION_MMRAD_MIN       = "1"
   ROB_OPTION_MMRAD_MAX       = "120"
   ROB_OPTION_ICONS           = "Options de l'icon :"
   ROB_OPTION_NAIL            = "Position de la prochaine action :"
   ROB_OPTION_ICONSCALE       = "Taille del'icon :"
   ROB_OPTION_ICONS_CV        = "1"
   ROB_OPTION_ICONS_MIN       = ".1"
   ROB_OPTION_ICONS_MAX       = "3.5"
   ROB_OPTION_ICONS_T_A       = "Activer la transparence des icons :"
   ROB_OPTION_ICONS_C_A       = "Transparence de l'action actuelle :"
   ROB_OPTION_ICONS_N_A       = "Transparence de la prochaine action :"
   ROB_OPTION_ICONS_T_ATT     = "Entrez une valeur entre |cFF00FF00.1|r et |cFF00FF00 1|r\npour régler le niveau de transparence de l'icone.\n— |cFF00FF00 1|r pour que celle-ci soit plainement visible.\n— |cFF00FF00 .1|r pour qu'elle soit pratiquement invisible."
   
   ROB_OPTION_IMPORT          = "Options d'Import/Export :"   
   ROB_OPTION_LOCKICONS       = "Vérouiller les icons"
   ROB_OPTION_LOCKICONS_TT    = "Vérouiller les icons pour éviter leur déplacement"
   ...
   ROB_OPTION_UPDATERATE      = "Rafraichissement pas secondes :"
